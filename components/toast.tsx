...
export function Toast({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed left-4 top-4 z-80 flex w-[min(22rem,calc(100vw-2rem))] items-center gap-4 rounded-2xl border border-black/5 bg-[#fff7f1] px-5 py-4 shadow-xl ring-1 ring-black/5 motion-safe:animate-[stepInLeft_0.22s_ease] dark:border-white/10 dark:bg-[#1e1a15] dark:ring-white/5"
    >
