...
export function MarketplaceSearchMorph({ defaults }: { defaults: Defaults }) {
  ...
  return (
    <>
      ...
      >
        <div className="flex max-w-[92vw] items-center rounded-full border border-black/5 bg-[#fff7f1] p-1.5 pl-1 shadow-lg shadow-zinc-900/10 transition-shadow hover:shadow-xl dark:border-white/10 dark:bg-[#1e1a15]">
          <button
            type="button"
            onClick={expand}
            className="flex max-w-[26vw] items-center gap-1.5 truncate rounded-full px-4 py-2.5 text-sm font-semibold text-foreground transition-colors duration-200 ease-out hover:bg-orange-50 dark:hover:bg-white/10"
          >
          ...
          <button
            type="button"
            onClick={expand}
            className="flex max-w-[26vw] items-center gap-1.5 truncate rounded-full px-4 py-2.5 text-sm font-medium text-zinc-500 transition-colors duration-200 ease-out hover:bg-orange-50 dark:text-zinc-400 dark:hover:bg-white/10"
          >
