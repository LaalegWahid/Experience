    ...
    <>
      ...
      <div className="sticky top-[4.5rem] z-30">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-full border border-zinc-200 bg-background px-3 py-2.5 shadow-md shadow-zinc-900/5 transition-shadow active:shadow-sm dark:border-zinc-800"
        >
      ...
      {open && (
        <div className="fixed inset-0 z-[60] flex flex-col bg-background">
          ...
          <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-4">
            {/* Where */}
            <label className="flex flex-col gap-1.5 rounded-2xl border border-zinc-200 px-4 py-6 dark:border-zinc-800">
            ...
            <label className="flex flex-col gap-1.5 rounded-2xl border border-zinc-200 px-4 py-6 dark:border-zinc-800">
              ...
              <select
                ...
                className="cursor-pointer bg-transparent text-base text-foreground outline-none"
              >
          ...
          <div className="border-t border-zinc-200 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] dark:border-zinc-800">
            <button
              type="button"
              onClick={submit}
