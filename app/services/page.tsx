  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        />
        {/* Fades from the page background (opaque, where the headline sits)
            to transparent, so the photo stays visible on the right. */}
        <div className="absolute inset-0 hidden bg-linear-to-r from-background via-background/85 to-transparent sm:block" />
