  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-background p-6 shadow-lg dark:border-zinc-800"
          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="flex h-10 items-center justify-center rounded-full px-4 text-sm font-medium text-foreground transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-800"
              >
                Cancel
              </button>
