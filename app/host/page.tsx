  ...
  return (
    <HostPage
      ...
      action={
        <Link
          ...
          className="flex h-11 items-center justify-center rounded-full bg-foreground px-5 text-sm font-medium text-background transition-colors hover:bg-zinc-700 dark:hover:bg-zinc-200"
        >
          New listing
        </Link>
      }
    >
      {!payoutMethod && (
        <Link
          href="/host/payouts"
          className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-accent/30 bg-accent/5 p-5 transition-colors hover:bg-accent/10"
        >
          <div>
      ...
      <section className="flex flex-col gap-3">
        ...
        {listings.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-zinc-300 bg-background p-10 text-center dark:border-zinc-700">
            <p className="text-zinc-600 dark:text-zinc-400">
              You don&apos;t have any listings yet.
            </p>
            <Link
              href="/host/listings/new"
              className="mt-4 inline-flex h-10 items-center justify-center rounded-full bg-foreground px-5 text-sm font-medium text-background transition-colors hover:bg-zinc-700 dark:hover:bg-zinc-200"
            >
