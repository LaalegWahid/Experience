  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="mx-auto w-full max-w-2xl">
        <div className="rounded-3xl border border-zinc-200 bg-background p-6 shadow-sm dark:border-zinc-800 dark:shadow-none sm:p-8">
          <div className="mb-6 flex items-center gap-3 border-b border-zinc-100 pb-5 dark:border-zinc-800">
