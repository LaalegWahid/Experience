...
function ReservationRow({
  ...
  return (
    <article className="flex items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-background p-4 dark:border-zinc-800">
          ...
          <div className="flex flex-col gap-2">
            {messages.map((c) => (
              <Link
                ...
                href="/host/messages"
                className="flex items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-background p-4 transition-colors hover:border-zinc-300 dark:border-zinc-800 dark:hover:border-zinc-700"
              >
                <div className="flex min-w-0 flex-col gap-0.5">
        ...
        {recent.length === 0 ? (
          ...
          <ul className="flex flex-col gap-2">
            {recent.map((b) => (
              <li
                key={b.id}
                className="flex items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-background p-4 dark:border-zinc-800"
              >
                <div className="flex min-w-0 flex-col gap-0.5">
                  <span className="truncate text-sm font-medium text-foreground">
