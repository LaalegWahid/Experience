...
const selectClass =
  "rounded-lg border border-zinc-300 bg-transparent px-3 py-2 text-sm font-medium text-foreground outline-none focus:border-accent dark:border-zinc-700 dark:focus:border-accent";
...
export function ListingEditSteps({
  ...
  const back = (
    <button
      ...
      disabled={step === 0}
      className="flex h-11 items-center justify-center rounded-full border border-zinc-300 px-5 text-sm font-medium text-foreground transition-colors hover:bg-zinc-100 disabled:opacity-40 dark:border-zinc-700 dark:hover:bg-zinc-900"
    >
      Back
    </button>
  );
  ...
  const next = (
    <button
      ...
      disabled={step === LAST}
      className="flex h-11 items-center justify-center rounded-full bg-accent px-6 text-sm font-medium text-accent-foreground transition-opacity hover:opacity-90 disabled:opacity-40"
    >
      Next
    </button>
  );
