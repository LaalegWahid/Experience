...
const inputClass =
  "rounded-lg border border-zinc-300 bg-transparent px-2 py-2 text-sm text-foreground outline-none focus:border-zinc-900 disabled:opacity-40 dark:border-zinc-700 dark:focus:border-zinc-300";
...
export function WeeklyScheduleManager({
  ...
  return (
    <form
      action={action}
      className="flex flex-col gap-4 rounded-2xl border border-zinc-200 bg-background p-5 dark:border-zinc-800"
    >
