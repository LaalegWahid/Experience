  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-black/5 bg-[#fff7f1] p-5 dark:border-white/10 dark:bg-[#1e1a15]">
      ...
      <button
        ...
        onClick={save}
        disabled={pending}
        className="w-full rounded-full bg-accent px-4 py-2 text-sm font-medium text-accent-foreground transition-all duration-200 ease-out hover:-translate-y-0.5 hover:opacity-90 disabled:pointer-events-none disabled:opacity-50"
      >
      ...
      {enabled && (
        <label className="mt-3 flex items-center gap-2 text-sm text-foreground">
          <input
            ...
            className="w-16 rounded-lg border border-black/10 px-3 py-1.5 text-center font-semibold outline-none transition-colors duration-200 ease-out focus:border-accent dark:border-white/10 dark:bg-transparent"
          />
